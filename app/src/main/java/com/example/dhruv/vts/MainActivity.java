...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.getMenu().performIdentifierAction(R.id.homeScreen, 0);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        ft = frm.beginTransaction().setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        if (id == R.id.view_profile) {
           ...
           startActivity(in);
            ...
            fr = new Fragment_accSettings();
            ft.replace(R.id.fragHost, fr);
    ...
    void onClick(View view) {
        ...
        if (view.getId() == R.id.location) {
            in = new Intent(this, Location_User.class);
            startActivity(in);
        }
